...
const MainBlogCard = ({mediaSource,mainBlogTitle,author,tag,date,mainBlogText,mainBlogJob}) => {
  ...
  return (
    ...
    <div className='main-blog-card'>
        ...
        <img className='main-blog-card__img' src={mediaSource} alt='' />
            ...
            <p className=' font-semibold  text-xl py-5  main-blog-card__title cursor-pointer '>{mainBlogTitle}</p>

            <p className='main-blog-card__desc  italic cursor-pointer font-medium'> 
                {author} / {tag} / {date}
            </p>

            <p className=' text-gray-500 my-4  line-clamp-4'> {mainBlogText} </p>
            ...
            <div className=' flex justify-between items-center  main-blog-card__bottom  py-3' >
                ...
                <div className='main-blog-card__icons flex items-center'>
                    ...
                    <Link className='main-blog__icon' >
                        <span><TiSocialFacebook size={20}/></span></Link>
                    <Link className='main-blog__icon'>
                        <span ><TiSocialTwitter size={20}/></span></Link>
                    <Link className='main-blog__icon'>
                        <span><TiSocialLinkedin size={20}/></span></Link>
                    <Link className='main-blog__icon'>
                        <span><TiSocialTumbler size={20}/></span></Link>
                </div>
            </div>
        </div>
